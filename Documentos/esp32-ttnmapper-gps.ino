const char *devAddr = "26031FC4";
const char *nwkSKey = "CED81EB57C852D9015184F8F7B2DC27E";
const char *appSKey = "15CC9504CE8CB5519C14ABCF68797A9D";
#include <lmic.h>
#include <hal/hal.h>
#include <SPI.h>
#include "FS.h"
...
void setup() {
  ...
  do_send(&sendjob);
    ...
    listDir(SPIFFS, "/", 0);
    writeFile(SPIFFS, "/hello.txt", "/gpslocation.txt");
    appendFile(SPIFFS, "/hello.txt", "World!\r\n");
    readFile(SPIFFS, "/gpslocation.txt");
    renameFile(SPIFFS, "/hello.txt", "/gpslocation.txt");
    readFile(SPIFFS, "");
    testFileIO(SPIFFS, "/gpslocation.txt");
