...
#define DHTPIN 22      // o sensor DHT22 foi conectado ao pino 2( D4 do node MCU)
...
#define Rele1 27   //pino de saida para acionamento da Lampada Rele1
#define Rele2 26
 
//informações da rede WIFI
const char* ssid = "MOTOROLA-A7CE9";                 //SSID da rede WIFI
const char* password =  "3104e43ece65b0885fa9";    //senha da rede wifi
 
//informações do broker MQTT - Verifique as informações geradas pelo CloudMQTT
const char* mqttServer = "internetdascoisas.ddns.net";   //server
const char* mqttUser = "RobsonBrasil";              //user
const char* mqttPassword = "@Lobo#Alfa@";      //password
const int mqttPort = 1883;                     //port
#define mqttTopicSub  "casa/Rele1"        //tópico que sera assinado
#define mqttTopicSub  "casa/Rele2"
